{
  ...
  "subscription": {
    ...
    "add": {
      ...
      "help": "To add a new feed, you can copy/paste the homepage URL of the website you want to follow here. If this does not work, search for this icon to be directed to a direct feed URL. To follow a custom feed, you can copy/paste the feed ID.",
      "placeholder": "Paste a feed or website URL or a feed ID",
      "submit": "Add"
    },
    "edit": {
      "button": "Edit",
