...
public class StarredResource extends BaseResource {
    ...
    public Response star(
        ...
        // Increment starred count for the article
        ArticleDao articleDao = new ArticleDao();
        articleDao.incrementStarredCount(userArticle.getArticleId());
    ...
    public Response unstar(
        ...
        // Decrement starred count for the article
        ArticleDao articleDao = new ArticleDao();
        articleDao.decrementStarredCount(userArticle.getArticleId());
