...
public List<String> getFeedIds() { return feedIds; }
public UserArticleCriteria setFeedIds(List<String> feedIds) { this.feedIds = feedIds; return this; }

public List<String> getCategoryIds() { return categoryIds; }
public UserArticleCriteria setCategoryIds(List<String> categoryIds) { this.categoryIds = categoryIds; return this; }
