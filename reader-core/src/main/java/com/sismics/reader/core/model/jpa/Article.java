...
public class Article {
    ...
    @Column(name = "ART_STARREDCOUNT_N", nullable = false)
    ...
    /**
     * Setter of starredCount.
     *
     * @param starredCount starredCount
     */
    ...
    public JSONObject asJson() throws JSONException {
        ...
        // //     enclosure.put("length", enclosureLength);
        // //     enclosure.put("type", enclosureType);
        // //     articleJson.put("enclosure", enclosure);
        // // }
        // articleJson.put("date", publicationDate);
        // // articleJson.put("createDate", createDate);
        // // articleJson.put("deleteDate", deleteDate);
        // // articleJson.put("starredCount", starredCount);
        // return articleJson;
        ...
        userArticleJson.put("article_id", id);
        userArticleJson.put("title", title);
        userArticleJson.put("url", url);
        userArticleJson.put("date",publicationDate);
        userArticleJson.put("creator", creator);
        userArticleJson.put("description", description);
        userArticleJson.put("comment_url", commentUrl);
        userArticleJson.put("comment_count", commentCount);
        if (enclosureUrl != null) {
            JSONObject enclosure = new JSONObject();
            enclosure.put("url", enclosureUrl);
            enclosure.put("length", enclosureLength);
        ...
        userArticleJson.put("is_read", false);
        userArticleJson.put("is_starred", true);
        userArticleJson.put("starred_count", starredCount);
