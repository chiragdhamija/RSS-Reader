...
public class AdblockUtil {
    ...
    public void setSubscription(Subscription subscription) throws Exception {
        if (subscription != null) {
            ...
            jsonSub.put("url", subscription.getUrl());
            jsonSub.put("title", subscription.getTitle());
            jsonSub.put("homepage", subscription.getHomepage());
    ...
    public Subscription offerSubscription() {
        ...
        for (Subscription subscription : getSubscriptions()) {
            ...
            String prefix = checkLocalePrefixMatch(subscription.getPrefixes());
            if (prefix != null) {
