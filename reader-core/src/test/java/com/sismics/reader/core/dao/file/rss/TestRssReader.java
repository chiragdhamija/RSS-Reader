...
//         FeedParser parser = new RssFeedParser();
//         final ParsedFeed[] result = new ParsedFeed[1];
//         result[0] = parser.parse(is);
//         Feed feed = result[0].getFeed();
...
//         List<Article> articleList = result[0].getArticles();
...
//     /**
//      * This feed has a invalid URL
//      * https://itunes.apple.com/it/book/earth-from-space/id632294005?l=en&mt=11
//      * 
//      */
//     @Test
...
//         assertEquals(
//                 "http://www.lemessager.fr/Actualite/Genevois/2013/12/18/article_l_annemassienne_dana_brille_a_la_nouvell.shtml",
//                 article.getUrl());
...
//         assertEquals("http://www.blogger.com/comment.g?blogID=9184161806327478331&postID=186540250833288646",
//                 article.getCommentUrl());
...
//         Article article = articleList.get(0);
//         assertEquals("Collision Course? A Comet Heads for Mars", article.getTitle());
//         assertEquals("http://www.spacedaily.com/reports/Collision_Course_A_Comet_Heads_for_Mars_999.html",
//                 article.getUrl());
...
//         Article article = articleList.get(0);
//         assertEquals(
//                 "Quel navigateur Web recommandez-vous en 2013 ? Participez au débat sur le meilleur navigateur grand public",
//                 article.getTitle());
//         assertEquals(
//                 "http://web.developpez.com/actu/56767/Quel-navigateur-Web-recommandez-vous-en-2013-Participez-au-debat-sur-le-meilleur-navigateur-grand-public/",
//                 article.getUrl());
//         assertEquals(
//                 "http://web.developpez.com/actu/56767/Quel-navigateur-Web-recommandez-vous-en-2013-Participez-au-debat-sur-le-meilleur-navigateur-grand-public/",
//                 article.getGuid());
...
//         assertNull(article.getCommentUrl());
//         assertNull(article.getCommentCount());
//         assertTrue(article.getDescription().contains(
//                 "Depuis, les choses ont encore beaucoup évolué et nous aimerions connaitre votre avis actuel"));
//         assertNotNull(article.getPublicationDate());
//     }
...
//         // assertTrue(article.getDescription().contains("I spend a rather large fraction
//         // of my days inside Emacs"));
//         assertNotNull(article.getPublicationDate());
//     }
